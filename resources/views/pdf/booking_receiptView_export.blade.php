...
<div style="font-weight: bold; font-size: 20px; text-align: center;">RECEIPT</div>
        ...
        <div class="col-6">
            <table border="0" style="width:120%">
                <tr>
                    ...
                    <td style="text-align: left; width: 13%;">: &nbsp;{{ Carbon\Carbon::parse($data->shipment()->date)->format('d/m/Y') }}</td>
                    <th style="text-align: right;">Pol</th>
                    <td style="text-align: left;">: &nbsp;{{ $data->shipment()->port_from }}</td>
                </tr>
                <tr>
                    <th style="text-align: left;">Vessel No</th>
                    <td style="text-align: left;">: &nbsp;{{ $data->shipment()->number }}</td>
                    <th style="text-align: right;">Pod</th>
                    <td style="text-align: left;">: &nbsp;{{ $data->shipment()->port_to }}</td>
                </tr>
                <tr>
            ...
            <div class="row">
                <table border="0" style="width:100%">
                    <tr>
                        ...
                        <th style="text-align: center;width: 30%; background-color: rgb(6, 6, 155); color:white;">DESCRIPTION</th>
                        <th colspan="1" style="text-align: center;width: 40%; background-color: rgb(6, 6, 155); color:white;"></th>
                        <th style="text-align: center; width: 40%; background-color: rgb(6, 6, 155); color:white;">UNIT</th>
                        <th style="text-align: left; background-color: rgb(6, 6, 155); color:white;">AMOUNT</th>
                    </tr>
                    <tr>
                        <td style="text-align: center;">1</td>
                        <td style="text-align: center;">OCEAN FREIGHT</td>
                        <td style="text-align: center;">{{ $data->package()->car_category }}</td>
                        <td style="text-align: center;">{{ $data->vehicle()->plate_no }}</td>
                    ...
                    <tr>
                        <td colspan="3"><b>PAYMENT FULLY PAID</b></td>
