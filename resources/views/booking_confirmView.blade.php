...
<div class="text-center">
    <div  style="background-color: transparent; font-weight: bold; font-size: 20px;">CONFIRMATION BOOKING</div>
    <div><p></p></div>
</div>
...
<div class="row">
    <div class="col-6">
        <table border="0" style="width:210%">
            <tr>
                <th style="text-align: left;width: 20%;">Book No</th>
            ...
            <tr>
                <th style="text-align: left;width: 20%;">Customer No</th>
                <td style="text-align: left;">: &nbsp;{{ $booking->customer()->id}}</td> 
            </tr>
        </table>
    </div>
</div>
    ...
    <div class="col-6">
        <table border="0" style="width:210%">
            <tr>
                ...
                <td style="text-align: left;width: 45%;">: &nbsp;{{ $model_vehicle->make }} {{ $model_vehicle->model }}</td>
            ...
            <div class="col-6">
                <table border="0" style="width:220%">
                    <tr>
                        ...
                        <th style="text-align: center;width: 50%; background-color: rgb(6, 6, 155); color:white;">&nbsp;&nbsp;&nbsp;CODE</th>
            ...
            <div class="col-6">
                <table border="0" style="width:220%">
                    <tr>
                        ...
                        <td style="text-align: center;width: 50%;">SHIP</td>
            ...
            <tr>
                ...
                <td>
                    <div align="right" style="width:90%">
                        <b>Untuk Cetak Klik Sini --><b> &nbsp; <a href="{{route('booking.confirmPDF', $booking->id)}}" onclick="window.open(this.href, '_blank', 'left=20,top=20,width=800,height=500,toolbar=1,resizable=0'); return false;"  >
