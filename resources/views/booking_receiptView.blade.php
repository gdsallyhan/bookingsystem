...
<div class="text-center">
    <div  style="background-color: transparent; font-weight: bold; font-size: 20px;">RECEIPT</div>
    <div><p></p></div>
</div>
            ...
            <tr>
                ...
                <td>
                    <div align="right" style="width:90%">
                        <b>Untuk Cetak Klik Sini --><b> &nbsp; <a href="{{route('booking.receiptPDF', $booking->id)}}" onclick="window.open(this.href, '_blank', 'left=20,top=20,width=800,height=500,toolbar=1,resizable=0'); return false;"  >
